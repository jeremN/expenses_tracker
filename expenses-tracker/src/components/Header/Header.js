...
const header = (props) => {
	...
	const loggedMenu = (
		<Fragment>
			<NavigationItem link="/stats" itemClass={ Header__item }>{ t('Stats') }</NavigationItem>
			<NavigationItem link="/profil" itemClass={ Header__item }>{ t('Profil') }</NavigationItem>
			<NavigationItem link="/logout" itemClass={ Header__item }>{ t('Logout') }</NavigationItem>
		</Fragment>
	);
	...
	return (
		<header className={ Header }>
			<ul className={ Header__list }>
				<NavigationItem itemClass={ Header__item } link="/" exact>{ t('Home') }</NavigationItem> 
